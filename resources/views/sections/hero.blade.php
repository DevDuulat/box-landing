<section class="h-[calc(100vh-5rem)] md:h-[calc(100vh-6rem)] relative text-white overflow-hidden flex flex-col items-center pt-8 md:pt-12 bg-[#111111]
...
<div class="bg-mask absolute top-0 left-0 w-full h-32 md:h-64 bg-gradient-to-b from-[#111111] to-transparent z-20"></div>
    ...
    <div class="container mx-auto px-6 lg:px-8 relative z-30">
        <div class="flex flex-col items-center text-center">
            ...
            <div class="inline-block px-4 py-1.5 rounded-full border border-white/10 bg-white/5 mb-8 md:mb-6">
                <span class="text-[#FFA500] text-[10px] md:text-sm font-black tracking-[0.2em] uppercase">
                    {{ __('messages.hero_badge') }}
                </span>
            </div>

            <h1 class="text-4xl sm:text-4xl md:text-5xl lg:text-6xl font-black mb-8 md:mb-6 leading-tight tracking-tight px-2">
    ...
    <div class="absolute bottom-10 left-1/2 -translate-x-1/2 animate-bounce opacity-40 z-20 block">
