<header id="main-header" x-data="{ mobileMenuOpen: false }" class="fixed top-0 left-0 w-full z-50 bg-[#111111] transition-colors duration-300 font-montserrat">
    <div class="container mx-auto px-4 lg:px-8">
        <div class="flex items-center justify-between h-20 md:h-24">
            ...
            <nav class="hidden lg:flex items-center ml-[80px] space-x-10">
                <a href="#products" class="text-gray-400 hover:text-white transition-colors text-[18px] font-semibold">Продукция</a>
                <a href="#branding" class="text-gray-400 hover:text-white transition-colors text-[18px] font-semibold">Брендирование</a>
                <a href="#contacts" class="text-gray-400 hover:text-white transition-colors text-[18px] font-semibold">Контакты</a>
            </nav>
                ...
                <div x-data="{
                    ...
                    <div x-show="open" @click.outside="open = false" x-cloak class="absolute right-0 mt-2 w-32 bg-[#1a1a1a] rounded-xl shadow-2xl z-50 border border-gray-800 overflow-hidden">
                        <template x-for="lang in languages" :key="lang.code">
                            <button @click="currentLang = lang.code; currentFlag = lang.flag; open = false;" class="flex items-center space-x-3 w-full px-4 py-3 hover:bg-[#333] group">
    ...
    <div x-show="mobileMenuOpen"
         ...
         class="lg:hidden bg-[#1a1a1a] border-t border-gray-800 px-4 py-6 space-y-4 shadow-xl" x-cloak>
        <nav class="flex flex-col space-y-4">
            <a href="#products" @click="mobileMenuOpen = false" class="text-gray-300 text-lg font-semibold">Продукция</a>
            <a href="#branding" @click="mobileMenuOpen = false" class="text-gray-300 text-lg font-semibold">Брендирование</a>
            <a href="#contacts" @click="mobileMenuOpen = false" class="text-gray-300 text-lg font-semibold">Контакты</a>
        </nav>
